...
CREATE TABLE `tb_admin` (
  `adm_id` varchar(20) NOT NULL,
  `adm_passwd` varchar(32) NOT NULL,
  `adm_name` char(20) DEFAULT '',
  `adm_phone` char(20) DEFAULT '',
  `adm_addr` varchar(20) DEFAULT '',
  PRIMARY KEY (`adm_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tb_equipment` (
  ...
  `equ_type` varchar(20) DEFAULT '',
  `equ_purchasedate` date DEFAULT NULL,
  `equ_purchaser` char(20) DEFAULT '',
  `equ_singleprice` float DEFAULT NULL,
  `equ_unit` varchar(20) DEFAULT '',
  `equ_spec` varchar(100) DEFAULT NULL,
  `equ_total` int(11) DEFAULT '1',
  `equ_curr` int(11) DEFAULT '1',
  `equ_position` varchar(20) DEFAULT '',
...
CREATE TABLE `tb_factory` (
  ...
  `fac_name` varchar(20) DEFAULT '',
  `fac_addr` varchar(40) DEFAULT NULL,
  `fac_phone` varchar(20) DEFAULT '',
  PRIMARY KEY (`fac_id`)
...
CREATE TABLE `tb_faultrecord` (
  ...
  `fau_occurdate` date DEFAULT NULL,
  `fau_occurposition` varchar(20) DEFAULT NULL,
  `fau_detail` varchar(100) DEFAULT '',
  `fau_img` varchar(100) DEFAULT '',
  `adm_answer` varchar(100) DEFAULT '',
  `adm_del` tinyint(4) DEFAULT '0',
  `user_del` tinyint(4) DEFAULT '0',
  `adm_message` char(10) DEFAULT '无处理项',
  PRIMARY KEY (`fau_id`)
...
-- ----------------------------
INSERT INTO `tb_faultrecord` VALUES ('1', 'G0001', '2', '3182701101', '2020-06-12', '未知', '该设备在使用过程', 'E:\\JavaWeb\\EquipManage\\upload\\20200614174311093.jpeg', '123', '0', '1', '待处理');
INSERT INTO `tb_faultrecord` VALUES ('2', 'G0001', '2', '3182701101', '2020-06-02', '', '1234231', '无图片', '处理通过', '1', '1', '已处理');
INSERT INTO `tb_faultrecord` VALUES ('3', 'G0001', '2', '3182701101', '2020-06-14', '未知', '设备卡顿', 'E:\\JavaWeb\\EquipManage\\upload\\20200614223222149.jpeg', '', '0', '1', '待处理');
INSERT INTO `tb_faultrecord` VALUES ('4', 'G0001', '2', '3182701101', '2020-06-14', '未知', '设备卡顿', 'E:\\JavaWeb\\EquipManage\\upload\\20200614223230193.jpeg', '消息已收到', '0', '0', '待解决');
INSERT INTO `tb_faultrecord` VALUES ('5', 'G0001', '2', '3182701101', '2020-06-17', '实验室', '设备无法正常使用', '无图片', '', '0', '1', '待处理');
INSERT INTO `tb_faultrecord` VALUES ('6', 'G0001', '2', '3182701101', '2020-06-19', '教室B207', '教学楼B203有7张桌椅磨损，螺丝松动不稳固', 'E:\\JavaWeb\\EquipManage\\upload\\20200619220725102.jpeg', '', '0', '0', '待处理');
INSERT INTO `tb_faultrecord` VALUES ('7', 'G0001', '2', '3182701101', '2020-06-20', '未知', '测试', 'E:\\JavaWeb\\EquipManage\\upload\\20200621193137355.png', '', '0', '0', '待处理');
...
CREATE TABLE `tb_feedback` (
  ...
  `user_id` varchar(20) NOT NULL,
  `fee_question` varchar(30) DEFAULT '',
  `fee_detail` varchar(150) DEFAULT '',
  `adm_message` char(10) DEFAULT '',
  `adm_answer` varchar(150) DEFAULT '',
  `del` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`fee_id`)
...
CREATE TABLE `tb_purchase` (
  ...
  `pur_applyreason` varchar(100) DEFAULT NULL,
  `pur_purchasenumber` int(11) DEFAULT NULL,
  `pur_price` float DEFAULT NULL,
  `pur_applydate` date DEFAULT NULL,
  `adm_dealstatus` char(10) DEFAULT '无处理项',
  `adm_reply` varchar(100) DEFAULT '',
  PRIMARY KEY (`pur_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tb_scraprecord` (
  ...
  `adm_id` varchar(20) NOT NULL,
  `equ_id` int(11) NOT NULL,
  `scr_reason` varchar(100) DEFAULT '',
  `scr_date` date DEFAULT NULL,
  PRIMARY KEY (`scr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tb_temp` (
  ...
  `tname` varchar(2) DEFAULT '',
  `tmsg` varchar(2) DEFAULT 'ch',
  `salary1` float DEFAULT '0',
  `salary2` double(15,11) DEFAULT '9.01234567890',
  `tage` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`tid`)
...
CREATE TABLE `tb_user` (
  ...
  `user_academy` varchar(20) DEFAULT '',
  `user_email` char(20) DEFAULT '',
  `user_phone` char(20) DEFAULT '',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('1112223334', '823693', '姚佳艺', '老师', '计算机与控制工程学院', '873411729@qq.com', ' 18649823693');
INSERT INTO `tb_user` VALUES ('1112223335', '390782', '陈雄峰', '老师', '计算机与控制工程学院', '345390782@qq.com', ' 18647323593');
INSERT INTO `tb_user` VALUES ('1112223336', '823693', '徐戈', '老师', '计算机与控制工程学院', '449013739@qq.com', ' 18649523643');
INSERT INTO `tb_user` VALUES ('1112223337', '509200', '范振成', '老师', '数学与数据科学学院', '1070509200@qq.com', ' 18643823673');
INSERT INTO `tb_user` VALUES ('1112223338', '427841', '陈亮', '老师', '经济与管理学院', '54278414@qq.com', ' 18649823693');
INSERT INTO `tb_user` VALUES ('1112223339', '593012', '古凡', '老师', '体育学院', '675593012@qq.com', ' 18649823693');
INSERT INTO `tb_user` VALUES ('3182701101', '640086', '林心怡', '学生', '人文学院', '1254640086@qq.com', ' 13110769174');
INSERT INTO `tb_user` VALUES ('3182703137', '945067', '翁丽丽', '学生', '计算机与控制工程学院', '180945067@qq.com', ' 13799326120');
INSERT INTO `tb_user` VALUES ('3182703158', '921127', '王丹', '学生', '计算机与控制工程学院', '2636558760@qq.com', ' 18748757075');
INSERT INTO `tb_user` VALUES ('3182703160', '524400', '罗艳丽', '学生', '计算机与控制工程学院', '3249652440@qq.com', ' 13110769173');
INSERT INTO `tb_user` VALUES ('sky666', 'skypw666', '王阳', '学生', '计算机系', '2220940457@qq.com', '17823457711');
...
CREATE TABLE `tb_usingrecord` (
  ...
  `usi_number` int(11) DEFAULT '1',
  `usi_date` date DEFAULT NULL,
  `usi_returndate` date DEFAULT NULL,
  `usi_applystatus` char(10) DEFAULT '无处理项',
  `adm_feedbackapply` varchar(100) DEFAULT '',
  `usi_returnstatus` char(10) DEFAULT '无处理项',
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_admdealusi`(
usiid int,equid int,usinumber int,usiapplystatus char(10),admfeedbackapply varchar(100),
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_borrowequ`(
user_id varchar(20),
equid int,
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_delequip`(usertype int,admid varchar(20),equid int,out result int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_delfaultrecord`(fauid varchar(20),usertype int)
begin
	if usertype=1 then 
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_delusingrecord`(deltype int,usiid int,out result int)
begin 
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_insertadmequ`(p1 int,p2 varchar(20))
begin 
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_insertequip`(
equ_name varchar(20),
equ_type varchar(20),
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_queryequ`( equtype varchar(20),out snt int)
begin
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_scrap`(admid varchar(20),equid int,scrreason varchar(100),scrdate date,out result int)
begin 
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_usingrecord`(usertype int,userid varchar(20),rpos1 int,rpos2 int)
begin
if usertype=1 then 
